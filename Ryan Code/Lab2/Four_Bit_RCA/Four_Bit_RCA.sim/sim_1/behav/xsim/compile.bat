...
REM
REM Generated by Vivado on Mon Feb 14 13:51:22 -0500 2022
...
echo "xvhdl --incr --relax -prj tb_nbit_RCA_vhdl.prj"
call xvhdl  --incr --relax -prj tb_nbit_RCA_vhdl.prj -log xvhdl.log
