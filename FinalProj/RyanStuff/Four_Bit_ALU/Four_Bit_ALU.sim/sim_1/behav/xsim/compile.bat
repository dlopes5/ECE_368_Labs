...
REM
REM Generated by Vivado on Sun Apr 17 12:23:16 -0400 2022
...
echo "xvhdl --incr --relax -prj tb_ALU4_vhdl.prj"
call xvhdl  --incr --relax -prj tb_ALU4_vhdl.prj -log xvhdl.log
