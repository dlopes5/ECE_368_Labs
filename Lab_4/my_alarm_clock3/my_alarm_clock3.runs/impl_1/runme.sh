...
HD_PWD='C:/Users/Daniel/Desktop/ECE_368_Field_Programmable_Gate_Arrays/my_alarm_clock3/my_alarm_clock3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_alarm_clock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_alarm_clock.tcl -notrace
