...
HD_PWD='C:/Users/Daniel/Desktop/ECE_368_Field_Programmable_Gate_Arrays/my_alarm_clock3/my_alarm_clock3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_alarm_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_alarm_clock.tcl
