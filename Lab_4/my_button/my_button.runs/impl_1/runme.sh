...
HD_PWD='C:/Users/Daniel/Desktop/my_button/my_button.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_button.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_button.tcl -notrace
