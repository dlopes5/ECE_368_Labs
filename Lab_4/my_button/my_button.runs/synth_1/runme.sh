...
HD_PWD='C:/Users/Daniel/Desktop/my_button/my_button.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_button.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_button.tcl
