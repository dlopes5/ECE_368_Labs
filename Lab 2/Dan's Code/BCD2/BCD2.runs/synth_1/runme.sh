...
HD_PWD='C:/Users/Daniel/Desktop/BCD2/BCD2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_BCD_Converter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_BCD_Converter.tcl
